...
0000000000001149 <main>:
    ...
    1164:	dd 05 9e 0e 00 00    	fldl   0xe9e(%rip)        # 2008 <_IO_stdin_used+0x8>
    116a:	dd 05 a0 0e 00 00    	fldl   0xea0(%rip)        # 2010 <_IO_stdin_used+0x10>
    1170:	de c1                	faddp  %st,%st(1)
    1172:	db 7d e0             	fstpt  -0x20(%rbp)
    1175:	dd d9                	fstp   %st(1)
    1177:	dd d8                	fstp   %st(0)
    1179:	b8 00 00 00 00       	mov    $0x0,%eax
    117e:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1182:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1189:	00 00 
    118b:	74 05                	je     1192 <main+0x49>
    118d:	e8 be fe ff ff       	call   1050 <__stack_chk_fail@plt>
    1192:	c9                   	leave  
    1193:	c3                   	ret    
