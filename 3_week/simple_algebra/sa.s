...
0000000000001129 <main>:
    ...
    1132:	48 b8 dd dd cc cc bb 	movabs $0xaaaabbbbccccdddd,%rax
    1139:	bb aa aa 
    113c:	48 89 45 e8          	mov    %rax,-0x18(%rbp)

    1140:	48 b8 44 44 33 33 22 	movabs $0x1111222233334444,%rax
    1147:	22 11 11 
    114a:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    
    114e:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1152:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    1156:	48 89 d3             	mov    %rdx,%rbx
    1159:	48 01 c3             	add    %rax,%rbx
    115c:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1160:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    1164:	48 89 d3             	mov    %rdx,%rbx
    1167:	48 29 c3             	sub    %rax,%rbx
    116a:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    116e:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    1172:	48 89 d3             	mov    %rdx,%rbx
    1175:	48 21 c3             	and    %rax,%rbx
    1178:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    117c:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    1180:	48 89 d3             	mov    %rdx,%rbx
    1183:	48 09 c3             	or     %rax,%rbx
    1186:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    118a:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    118e:	48 89 d3             	mov    %rdx,%rbx
    1191:	48 31 c3             	xor    %rax,%rbx
    1194:	b8 00 00 00 00       	mov    $0x0,%eax
    1199:	48 8b 5d f8          	mov    -0x8(%rbp),%rbx
    119d:	c9                   	leave  
    119e:	c3                   	ret    
