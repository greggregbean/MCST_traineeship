...
0000000000001169 <main>:
    ...
    1184:	c7 45 c0 00 00 00 00 	movl   $0x0,-0x40(%rbp)
    118b:	c7 45 c4 02 00 00 00 	movl   $0x2,-0x3c(%rbp)
    1192:	c7 45 c8 01 00 00 00 	movl   $0x1,-0x38(%rbp)
    1199:	c7 45 cc 02 00 00 00 	movl   $0x2,-0x34(%rbp)

    11a0:	c7 45 d0 08 00 00 00 	movl   $0x8,-0x30(%rbp)
    11a7:	c7 45 d4 05 00 00 00 	movl   $0x5,-0x2c(%rbp)
    11ae:	c7 45 d8 00 00 00 00 	movl   $0x0,-0x28(%rbp)
    11b5:	c7 45 dc 06 00 00 00 	movl   $0x6,-0x24(%rbp)

    11bc:	48 8d 45 c0          	lea    -0x40(%rbp),%rax
    11c0:	66 0f 6f 00          	movdqa (%rax),%xmm0
    11c4:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    11c8:	66 0f 6f 08          	movdqa (%rax),%xmm1
    11cc:	66 0f fe c8          	paddd  %xmm0,%xmm1
    11d0:	0f 29 4d e0          	movaps %xmm1,-0x20(%rbp)
    
    11d4:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%rbp)
    11db:	eb 23                	jmp    1200 <main+0x97>
    11dd:	8b 45 bc             	mov    -0x44(%rbp),%eax
    11e0:	48 98                	cltq   
    11e2:	8b 44 85 e0          	mov    -0x20(%rbp,%rax,4),%eax
    ...
    11f7:	e8 74 fe ff ff       	call   1070 <printf@plt>
    11fc:	83 45 bc 01          	addl   $0x1,-0x44(%rbp)
    1200:	83 7d bc 03          	cmpl   $0x3,-0x44(%rbp)
    1204:	7e d7                	jle    11dd <main+0x74>
    1206:	b8 00 00 00 00       	mov    $0x0,%eax
    120b:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    120f:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1216:	00 00 
    1218:	74 05                	je     121f <main+0xb6>
